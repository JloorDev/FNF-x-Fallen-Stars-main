...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Chromatic Aberration Shader', 'Value 1: Character/Camera (Gf,Bf,Dad,camGame,camHud)\nThe shaders are not activated when you activate the graphics in low.'],
		['VCRDistorsion Shader', 'Value 1: Character/Camera (Gf,Bf,Dad,camGame,camHud)\nValue 2: Distorsion Offset\nThe shaders are not activated when you activate the graphics in low.'],
		['Glitch Shader', 'Value 1: Character/Camera (Gf,Bf,Dad,camGame,camHud)\nThe shaders are not activated when you activate the graphics in low.']
	];
